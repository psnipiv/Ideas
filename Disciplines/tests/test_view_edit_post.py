...
class PostUpdateViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.idea = Idea.objects.create(subject='Test Idea', discipline=self.discipline, starter=user)
        self.post = Post.objects.create(message='Test Post', idea=self.idea, created_by=user)
        self.url = reverse('edit_post', kwargs={
            'pk': self.discipline.pk,
